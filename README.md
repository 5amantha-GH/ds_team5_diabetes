...
#### Findings:
![Diabetes Diagnosis Outcomes](images/diabetes_diagnoses.png){: width="50%"}
...
![Gender Distribution](images/gender_distribution.png){: width="50%"}
...
![Correlation Matrix of Symptom](images/correlation_matrix.png){: width="50%"}
...
![Age Distribution](images/age_distribution.png){: width="50%"}
...
![Age and Diabetes Class by Gender](images/age_gender_class.png){: width="50%"}
...
![Overall Symptom Prevalence](images/overall_symptom_prevelance.png){: width="50%"}
...
![Symptom Prevalence between Diabetic and Non-Diabetic Participants](images/symptom_prevalence_among_diabetic_by_gender.png){: width="50%"}
...
![Symptom Prevalence among Diabetic Participants by Gender](images/symptom_prevalence_diabetic_non_diabetic_participants.png){: width="50%"}
...
![Symptom Prevalence among Diabetic Participants by Gender](images/top_gender_differences_among_diabetic.png){: width="50%"}
...
![Symptom Prevalence by Diabetes Status](images/sym_prev_status.png){: width="50%"}
